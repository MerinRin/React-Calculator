...
function App() {
  ...
  return (
    <div className="container-fluid h-screen flex w-full justify-center items-center bg-pink-50 p-10">
      <div className="container bg-pink-100 md:h-[640px] h-[440px] w-[550px] rounded-2xl border border-pink-900 shadow-md shadow-black md:p-3">
